...
- `Numbers`:  1234, 3.145, 0b111, Decimal(), 3+4j, Fraction()
...
- `List Data Type` are similar to arrays found in other languages. They are an ordered and mutable collection of items. It is very flexible as items in a list do not need to be of the same type.
